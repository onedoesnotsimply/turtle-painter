 ...
 * Usage example:
 * <pre>
 * TurtlePaint.src.main.java.com.pluralsight.form.World w = new TurtlePaint.src.main.java.com.pluralsight.form.World();
 *
 * TurtlePaint.src.main.java.com.pluralsight.form.Turtle t = new TurtlePaint.src.main.java.com.pluralsight.form.Turtle(w);
 * t.forward(300);
 * t.setPenWidth(10);
 * t.backward(100);
 * t.right(135);
...
public class Turtle {
     ...
     * Should only be called by TurtlePaint.src.main.java.com.pluralsight.form.World class
    ...
    /**
     * Returns the current Color of the TurtlePaint.src.main.java.com.pluralsight.form.Turtle.
    ...
    /**
     * Changes the current Color of the TurtlePaint.src.main.java.com.pluralsight.form.Turtle.
    ...
    /**
     * Find out what direction the TurtlePaint.src.main.java.com.pluralsight.form.Turtle is facing
    ...
    /**
     * Set the direction the TurtlePaint.src.main.java.com.pluralsight.form.Turtle is facing
