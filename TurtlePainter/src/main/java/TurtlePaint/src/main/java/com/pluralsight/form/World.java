 ...
 * Usage example:
 * <pre>
 * TurtlePaint.src.main.java.com.pluralsight.form.World basic = new TurtlePaint.src.main.java.com.pluralsight.form.World();
 * TurtlePaint.src.main.java.com.pluralsight.form.World fancy = new TurtlePaint.src.main.java.com.pluralsight.form.World(640, 480, Color.YELLOW);
 *
 * TurtlePaint.src.main.java.com.pluralsight.form.Turtle t1 = new TurtlePaint.src.main.java.com.pluralsight.form.Turtle(basic);
 * TurtlePaint.src.main.java.com.pluralsight.form.Turtle t2 = new TurtlePaint.src.main.java.com.pluralsight.form.Turtle(fancy);
 *
 * t1.forward(100);
 * basic.erase();
 * t1.turnLeft(90);
...
public class World extends JFrame {
    ...
    /**
     * Creates a new TurtlePaint.src.main.java.com.pluralsight.form.World for Turtles to play in.
     */
    public World() {
        this(600, 600);
    }
    ...
    public World(int width, int height, Color backgroundColor) {
        super("TurtlePaint.src.main.java.com.pluralsight.form.Turtle TurtlePaint.src.main.java.com.pluralsight.form.World");
    ...
    /**
     * Should only called by the TurtlePaint.src.main.java.com.pluralsight.form.Turtle class constructor
     */
    ...
    /**
     * Should only called by TurtlePaint.src.main.java.com.pluralsight.form.Turtle class methods
     */
    ...
    /**
     * To be used by TurtlePaint.src.main.java.com.pluralsight.form.Turtle class only
